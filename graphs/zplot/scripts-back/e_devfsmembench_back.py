...
def main(argv):
	...
	#axis(d, xtitle=xlegend, xmanual=t.query(select='Threads,rownumber'),
	 #    ytitle='Throughput (ops/sec)', yauto=[0,ymax,yint], ytitlesize = 20, xtitlesize = 10)

	axis(d, xtitle=xlegend, xtitleshift=[0,-10], xmanual=t.query(select='ops,rownumber'),
	     ytitle='Memory (MB)', yauto=[0,ymax,yint], ylabelfontsize=yfont, xlabelfontsize=xfont, 
	...
	barargs = {'drawable':d, 'table':t, 'xfield':'rownumber',
		   'linewidth':0, 'fill':True, 'barwidth':0.5,
