...
def main(argv):
	...
	#xlegend='#. of files'
	xlegend='      RandWrite               RandRead                       Append'
	xfont = 17
	yfont = 17
	xdim = 650
	ydim = 280
	...
	print t.query(select='ops,rownumber')
	...
	barargs['yfield'] = 'NOVA'
	barargs['legendtext'] = 'Througput'
	barargs['fillcolor'] = 'gray'
	p.verticalbars(**barargs)

	barargs['yfield'] = 'DevFS_J'
	barargs['legendtext'] = 'Througput'
	barargs['fillcolor'] = 'gray'
	p.verticalbars(**barargs)

	barargs['yfield'] = 'DevFS_NoJ'
	barargs['legendtext'] = 'Througput'
	barargs['fillcolor'] = 'gray'
	p.verticalbars(**barargs)

	barargs['yfield'] = 'DevFS_NoJ_K'
	barargs['legendtext'] = 'Througput'
	barargs['fillcolor'] = 'gray'
	p.verticalbars(**barargs)
