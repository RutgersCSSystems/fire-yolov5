...
def main(argv):
	...
	axis(d, xtitle=xlegend, xmanual=t.query(select='qsize,rownumber'),
	     ytitle='Throughput (MB.sec)', yauto=[0,ymax,yint])
	...
	# randread bar
	barargs['yfield'] = 'thrput'
	barargs['legendtext'] = 'Throughput (MB/sec)'
