...
def main(argv):
        ...
        #xlegend='#. of files'
        xlegend='      DevFS-J               DevFS-NoJ                       NOVA'
        xfont = 17
        yfont = 17
        xdim = 650
        ydim = 280
	...
	NOVA = [row[0] for row in data]
	DevFS_J = [row[1] for row in data]
	DevFS_NoJ = [row[2] for row in data]
	DevFS_NoJ_K = [row[3] for row in data]
	FS = ['NOVA', 'DevFS-J', 'DevFS-NoJ', 'DevFS-NoJ-K']
	...
	rects0 = plt.bar(index, NOVA, bar_width,
			 alpha=opacity,
			 color='#a9a9a9',                 
			 edgecolor = "grey",  
			 label=FS[0])

	rects1 = plt.bar(index+ bar_width, DevFS_J, bar_width,
			 alpha=opacity,
			 color='gray',                 
			 edgecolor = "k",  
			 label=FS[1])

	rects2 = plt.bar(index+ 2*bar_width, DevFS_NoJ, bar_width,
			 alpha=opacity,
			 color='#000000',
			 edgecolor = "k",  
			 hatch='/',
	...
	rects3 = plt.bar(index+ 3*bar_width, DevFS_NoJ_K, bar_width,
			 alpha=opacity,
			 color='#000000',
			 edgecolor = "k",  
			 label=FS[2])
	...
	plt.xticks(index + bar_width, ("Append", "RandWrite", "RandRead"))
	legend =plt.legend( (rects0[0], rects1[0], rects2[0], rects3[0]), ('NOVA', 'DevFS-J', 'DevFS-NoJ', 'DevFS-NoJ-K'))
