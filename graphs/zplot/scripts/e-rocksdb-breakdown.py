...
xlabel = ['writeseq', 'readseq', 'writerand', 'readrand', 'overwrite']
pattern = ['writeseq', 'readseq']
...
path='data/rocksdb-breakdown/e-rocksdb'
...
axis(drawable=d, style='xy',
        xmanual=[[pattern[0],2.5],[xlabel[1],7.5],[xlabel[2],12.5]],
     yauto=[0,ymax,yint],
