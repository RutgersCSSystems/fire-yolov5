...
def main(argv):
	...
	axis(d, xtitle=xlegend, xmanual=t.query(select='randwrite,rownumber'),
	...
	# randread bar
	barargs['yfield'] = 'Ext4_DAX'
	barargs['legendtext'] = 'Ext4_DAX'
	...
	# storage bar
	#barargs['stackfields'].append(barargs['yfield'])
	#barargs['yfield'] = 'DevFS_OPT_Alloc'
	#barargs['legendtext'] = 'DevFS_OPT_Alloc'
	#barargs['fillcolor'] = 'blue'
	#p.verticalbars(**barargs)

	# storage bar
	#barargs['stackfields'].append(barargs['yfield'])
	#barargs['yfield'] = 'DevFS_OPT_Alloc_NoCntxSwitch'
	#barargs['legendtext'] = 'DevFS_OPT_Alloc_NoCntxSwitch'
