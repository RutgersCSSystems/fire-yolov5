...
#BENCHMARKS AND LIBS
#export MACHINE_NAME="WISC-SSD"
#export OUTPUT_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-SATASSD-CLOUDLAB/BUDGET
#export OUTPUT_GRAPH_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-SATASSD-CLOUDLAB/BUDGET

export MACHINE_NAME="CLEMSON"
export OUTPUT_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS/BUDGET
export OUTPUT_GRAPH_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS/BUDGET
