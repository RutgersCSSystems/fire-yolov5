...
#export OUTPUT_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-SATASSD-CLOUDLAB-TRIAL2
#export OUTPUT_GRAPH_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-SATASSD-CLOUDLAB
