...
export OUTPUT_FOLDER=$NVMBASE/results/SUDARSUN-PAPER-LOCAL-CLEMSON-PREDICT-OCT16
export OUTPUT_FOLDER=$NVMBASE/results/SUDARSUN-PAPER-LOCAL-Sep16-CLEMSON-PREDICT-OCT7
