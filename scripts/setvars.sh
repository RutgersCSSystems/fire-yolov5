...
export MACHINE_NAME="HOTCARBON-FINAL-MEMFRAC"
export OUTPUT_FOLDER=$NVMBASE/results/$MACHINE_NAME/WILDFIRE
export OUTPUT_GRAPH_FOLDER=$NVMBASE/results/$MACHINE_NAME/WILDFIRE
