...
legends=['Vanilla', 'OSonly', 'Cross_Info_sync', 'CIPB']
legendtext=['Vanilla', 'OSonly', 'Cross-Info', 'Cross-Info[+Predict +Budget]']
...
axis(d, linewidth=0.5, xtitle='#App Threads',
        xtitlesize=XTSIZE, xmanual=t.query(select='reader,rownumber'), xlabelfontsize=5, ytitle='Throughput (OPS/sec)',
