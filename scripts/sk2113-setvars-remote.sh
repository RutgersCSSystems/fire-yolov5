...
#BENCHMARKS AND LIBS
export MACHINE_NAME="UTAH-NVME"
export OUTPUT_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-REMOTENVME-CLOUDLAB
export OUTPUT_GRAPH_FOLDER=$NVMBASE/results/$MACHINE_NAME/SC-RESULTS-REMOTENVME-CLOUDLAB
