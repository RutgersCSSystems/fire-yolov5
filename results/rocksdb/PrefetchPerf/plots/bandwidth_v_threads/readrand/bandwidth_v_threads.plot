...
set title "RocksDB-readrand Prefetching Characterization"
...
plot 'vanilla_readrand.csv' u "VANILLA-avg":"VANILLA-min":"VANILLA-max":xtic(1) title "Vanilla", \
     'osonly_readrand.csv' u "OSONLY-avg":"OSONLY-min":"OSONLY-max" title "OS_Only", \
     'cfnmb_readrand.csv' u "CFNMB-avg":"CFNMB-min":"CFNMB-max" title "CFNMB", \
     'cfpmb_readrand.csv' u "CFPMB-avg":"CFPMB-min":"CFPMB-max" title "CFPMB", \
     'cbpmb_readrand.csv' u "CBPMB-avg":"CBPMB-min":"CBPMB-max" title "CBPMB"
