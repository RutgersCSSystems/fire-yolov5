...
#c = pdf('figure1.pdf')
c = canvas('pdf', title='rocksdb-pattern-throughput', dimensions=[120, 60])
t = table(file='ROCKSDB-PATTERN-TRIAL1.DATA')

d = drawable(canvas=c, coord=[20,12], xrange=[-0.5,t.getmax('rownumber')+0.5],
        yrange=[0,2000], dimensions=[95, 45])
...
axis(d, linewidth=0.5, xtitle='Access Pattern',
	...
	ytitlesize=5, ylabelfontsize=5, yauto=[0,2000,500], ticstyle='out', ticmajorsize=2, xlabelshift=[0,2], ylabelshift=[2,0], xtitleshift=[0,3],
    ytitleshift=[2,0])
...
#        hspace=1, skipnext=3, skipspace=22)
