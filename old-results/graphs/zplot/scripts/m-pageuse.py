...
def main(argv):
        ...
        #xlegend='#. of files'
        xlegend='      DevFS-J               App-pages                       Cache'
        xfont = 17
        yfont = 17
        xdim = 650
        ydim = 280
	...
	Cache = [row[0] for row in data]
	Migrated = [row[1] for row in data]
	Apppages = [row[2] for row in data]
	...
	legend =plt.legend( (rects0[0], rects1[0], rects2[0]), ('Cache', 'Migrated', 'App-pages'))
