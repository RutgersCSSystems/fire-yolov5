...
def main(argv):
	...
	axis(d, xtitle='#. of files', xmanual=t.query(select='ops,rownumber'),
	...
	barargs['yfield'] = 'ext4_inode_struct'
	barargs['legendtext'] = 'ext4_inode_struct'
	...
	# storage bar
	#barargs['stackfields'].append(barargs['yfield'])
	#barargs['yfield'] = 'ftrace'
	#barargs['legendtext'] = 'ftrace'
