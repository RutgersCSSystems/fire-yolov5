...
RESULTS_FOLDER=$OUTPUTDIR/$APP/bg-future-sensitivity-$RIGHTNOW
...
declare -a futureprefetch=("4" "10" "20" "50")
        ...
        do
            ...
            do 
                ...
                do 
                    ...
                    do
                        RUNAPP $NPROC $WORKLOAD $PREDICT $READSIZE $PREFETCHTIMES $FUTUREPREFETCH
                        REFRESH
