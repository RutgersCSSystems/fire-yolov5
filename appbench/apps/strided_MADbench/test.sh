...
/usr/bin/time -v mpiexec.mpich -n $NPROC ./MADbench2_io 4096 5 1 8 64 1 1 $RECORD $STRIDE $FLUSH
#/usr/bin/time -v mpiexec.mpich -n $NPROC ./MADbench2_io 16384 100 1 8 64 1 1 $RECORD $STRIDE $FLUSH
export LD_PRELOAD=
