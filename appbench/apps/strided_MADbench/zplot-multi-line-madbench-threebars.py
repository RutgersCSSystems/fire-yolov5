    ...
    for workload in WORKLOADS:
        ...
        for tup_inv in iter_invariants: #for each invariant permutation
            ...
            d = drawable(canvas=c, coord=[40,15], 
                    ...
                    yrange=[0, max_y])#dimensions=[500, 500])
            ...
            barargs['yfield'] = 'nobg_Elapsed'
            barargs['legendtext'] = 'sleep FG prefetch'
            ...
            barargs['yfield'] = 'bg_Elapsed'
            barargs['legendtext'] = 'sleep BG prefetch'
