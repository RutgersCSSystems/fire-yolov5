...
def train(hyp, opt, device, callbacks):
    ...
    """
    save_dir, epochs, batch_size, weights, single_cls, evolve, data, cfg, resume, noval, nosave, workers, freeze, cache_control_pipe, cache_size = (
        Path(opt.save_dir),
        opt.epochs,
        opt.batch_size,
        opt.weights,
    ...
    train_loader, dataset = create_dataloader(
        ...
        shuffle=True,
        seed=opt.seed,
        cache_control_pipe=opt.cache_control_pipe,
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cache-size", type=float, default=None, help="--cache-size 1.5 (this is in Gib)")
    parser.add_argument("--cache-control-pipe", type=str, default=None, help="--cache-control-pipe ./cache_pipe")
