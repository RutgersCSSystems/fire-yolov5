...
set title "Modified Linux IOR_32np_120GB RT vs RAsize"
...
plot '08-September-newnix_IOR-RT-seqread-diff-file-32_proc-120G_fsize-1M_tsize.dat' u "nopred":"nopred-min":"nopred-max":xtic(1) title "No App Pred", \
     '' u "pred":"pred-min":"pred-max" title "App Pred"

set output 'newnix_IOR_32np_120GB_seq_Runtime_v_RAsize.eps'
replot
