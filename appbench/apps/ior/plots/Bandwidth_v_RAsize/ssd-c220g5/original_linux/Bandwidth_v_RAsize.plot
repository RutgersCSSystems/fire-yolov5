...
set title "Original Linux IOR_32np_120GB BW vs RAsize SATA-SSD"
...
plot '08-September-ssd_oldnix_IOR-BW-seqread-diff-file-32_proc-120G_fsize-1M_tsize.dat' u "nopred":"nopred-min":"nopred-max":xtic(1) title "No App Pred", \
