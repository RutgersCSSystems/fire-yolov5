...
#set title "Program Runtime - Different Memory Budgets"
...
plot 'Errornrun.csv' u "Unlimited":"Unlimited-min":"Unlimited-max":xtic(1) title "Unlimited", \
     '' u "AppUsage":"AppUsage-min":"AppUsage-max" title "App_Level", \
     '' u "KernInstrMAX":"KernInstrMAX-min":"KernInstrMAX-max" title "System_Level"

set output 'Bandwidth_v_RAsize.eps'
replot
