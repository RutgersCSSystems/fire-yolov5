...
void write_sp_info(FILE *fp, char class) 
{
  ...
  else if (class == 'E') { problem_size = 1020; dt = "0.0001d0"; niter = 10; }
...
void write_bt_info(FILE *fp, char class) 
{
  ...
  else if (class == 'E') { problem_size = 1020; dt = "0.00002d0";    niter = 50; }
...
void write_lu_info(FILE *fp, char class) 
{
  ...
  else if (class == 'E') { problem_size = 1020; dt_default = "1.0d0"; itmax = 1; }
...
/*  else if (class == 'W') { problem_size = 64; nit = 40; }*/
  ...
  else if (class == 'E') { problem_size = 2048; nit = 4; }
...
void write_cg_info(FILE *fp, char class) 
{
  ...
  { na=9000000; nonzer=26; niter=15; shift="1.5d3"; }
...
void write_ua_info(FILE *fp, char class) 
{
  ...
  { lelt=7844800;lmor=291302900; refine_max=12; niter=50; nmxh=10; alpha="0.0294d0"; }
...
void write_ft_info(FILE *fp, char class) 
{
  ...
  else if (class == 'E') { nx = 4096; ny = 2048; nz = 2048; niter =5;}
