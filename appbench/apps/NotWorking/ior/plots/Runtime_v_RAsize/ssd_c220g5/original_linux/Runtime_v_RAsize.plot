...
set title "Original Linux IOR_32np_120GB RT vs RAsize SATA-SSD"
...
plot '08-September-ssd_oldnix_IOR-RT-seqread-diff-file-32_proc-120G_fsize-1M_tsize.dat' u "nopred":"nopred-min":"nopred-max":xtic(1) title "No App Pred", \
     '' u "pred":"pred-min":"pred-max" title "App Pred"

set output 'ssd_oldnix_IOR_32np_120GB_seq_Runtime_v_RAsize.eps'
replot
