...
set title "Vanilla Linux rocksdb 4M keys BW vs RAsize NVMe-SSD 32 AppThreads"
...
plot 'nvmessd_orignix_rocksdb-BW-readseq-32_appth-4096_valsz-1000_keysz-4000000_num-67108864_writebufsz_both.dat' u "nopred":"nopred-min":"nopred-max":xtic(1) title "No App Pred", \
     '' u "pred":"pred-min":"pred-max" title "App Pred"

set output 'nvmessd_orignix_rocksdb_readseq_Bandwidth_v_RAsize_32-AppTh_pred_comparison.eps'
replot
