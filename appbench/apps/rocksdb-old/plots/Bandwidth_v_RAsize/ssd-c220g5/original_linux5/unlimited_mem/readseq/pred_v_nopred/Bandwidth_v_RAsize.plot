...
set title "Vanilla Linux rocksdb 4M keys BW vs RAsize SATA-SSD 8 AppThreads"
...
plot 'ssd_oldnix_rocksdb-BW-readseq-8_appth-4096_valsz-1000_keysz-4000000_num-67108864_writebufsz_both.dat' u "nopred":"nopred-min":"nopred-max":xtic(1) title "No App Pred", \
     '' u "pred":"pred-min":"pred-max" title "App Pred"

set output 'ssd_oldnix_rocksdb_readseq_Bandwidth_v_RAsize_8-AppTh_pred_comparison.eps'
replot
