...
set title "Multi Tenant Rocksdb readseq perf with graphchi"
...
plot 'multitenant_rocksdb_graphchi.dat' u "readseq":"-":"-":xtic(1) title "Rocksdb(readseq)"

set output 'rocksdb_Bandwidth_multitenant_with_graphchi.eps'
replot
